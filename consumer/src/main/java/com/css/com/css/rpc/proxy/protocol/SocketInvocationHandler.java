...
public class SocketInvocationHandler extends AbstractInvocationHandler {
    Logger logger = Logger.getLogger(SocketInvocationHandler.class.getName());
    private String ip;
    private int port;
    /**
     * 代理类处理器
